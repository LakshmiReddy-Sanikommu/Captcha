...
opt={1:"bird",4:"cake",7:"road"}

#Generating Answer Booklet that is used to compare the Answers of the user

i=randrange(1,10,3)
img_ran={ 1:"b1.jpg", 2:"b2.jpg", 3:"b3.jpg", 4:"c1.jpg", 5:"c2.jpg", 6:"c3.jpg", 7:"r1.jpg", 8:"r2.jpg", 9:"r3.jpg"}
i1=randrange(1,10,1)
i2=randrange(1,10,1)
i3=randrange(1,10,1)
i4=randrange(1,10,1)
...
iT=[]
for x in range(9):
    if (iS[x]==i or iS[x]==i+1 or iS[x]==i+2):
        iT.append(iS[x])
        
#Creating Captcha GUI
...
but=Button(root,width=15,height=3,bd=5,fg="black",text="Verify",command=lambda: verCap())
but.grid(row=17,column=8)

#Verifying whether Selected Captcha is correct or not
